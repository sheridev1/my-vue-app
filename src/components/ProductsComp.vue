...
const maxPage = computed(() => {
    const totalItems = totalProducts.value;
...
<template>
    <div class="q-pa-md">
        ...
        <div class="q-mb-md q-ml-md">
            <span v-if="!loading">Displaying {{ sortedProducts.length }} out of {{ totalProducts }} products</span>
        </div>
                    ...
                    <q-card class="my-card" style="width:300px;" @click="viewProduct(item._id)">
                        ...
                        <q-card-section>
                            ...
                            <div class="text-subtitle2 text-left flex row justify-between" style="font-weight: 300;">$
                                ...
                                <div class="">
                                    {{ item.averageRating }}
                                    <q-rating v-model="star" :max="1" size="2em" color="#ffb302" icon="star_border"
